    ...
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8 py-6 sm:py-8">
        ...
        <div className="space-y-4 sm:space-y-6 text-foreground">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">2. Information We Collect</h2>
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong>Usage Analytics:</strong> Anonymous page views and device information via Vercel Analytics</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">3. How We Use Your Information</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-3">
              We use your information solely to:
            </p>
            <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1 ml-4">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">4. Data Storage and Security</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
              All your closet data (items, outfits, preferences) is stored exclusively in your personal Google Drive account. We do not store your data on our servers. The Service only accesses files it creates in your Google Drive and does not read or modify any other files. Your Google account credentials are never stored by us—authentication is handled entirely by Google.
            </p>
          </section>

          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">5. Data Sharing and Third Parties</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-3">
            ...
            <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-2 ml-4">
              ...
              <li><strong>Google OAuth:</strong> To authenticate your account securely</li>
              <li><strong>Vercel Analytics:</strong> To collect anonymous usage statistics (no personal data)</li>
            </ul>
          </section>

          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">6. Your Data Rights</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">7. Cookies and Local Storage</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">8. Children's Privacy</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">9. Changes to This Policy</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg sm:text-xl md:text-2xl font-heading font-semibold mb-2 sm:mb-3">10. Contact Us</h2>
            <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
