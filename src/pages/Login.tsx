 ...
 * Login Page
 * 
 * Simple Google sign-in page. Users must authenticate to access the app.
 * Styling uses the warm & cozy design tokens from index.css.
 * 
 * Customization:
 *  - Change the title/subtitle text below
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-3 sm:p-4 relative">
      ...
      >
        ...
        {/* Sign in button — rounded-xl for shape, bg-primary for color */}
        <Button
          onClick={onSignIn}
          disabled={loading}
